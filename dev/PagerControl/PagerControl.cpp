...
constexpr auto c_verticalPipsVisibleVisualState = L"VerticalPipsVisible"sv;
...
PagerControl::PagerControl()
{
    ...
    templateSettings.SetValue(PagerControlTemplateSettings::s_VerticalPipsItemsProperty, m_verticalPipsElements);
...
void PagerControl::OnApplyTemplate()
{
    ...
    [this](const winrt::ItemsRepeater repeater) {
        ...
        if (repeater) {
            ...
            repeater.ElementPrepared({ this, &PagerControl::OnElementPrepared });
...
void PagerControl::OnDisplayModeChanged()
{
    ...
    else if (displayMode == winrt::PagerControlDisplayMode::NumberBox)
    {
        ...
        winrt::VisualStateManager::GoToState(*this, c_verticalPipsVisibleVisualState, false);
    }
    else
    {
...
void PagerControl::AppendButtonToVerticalPipsList(const int pageNumber, const int numberOfPages) {
    m_verticalPipsElements.Append(box_value(pageNumber));
}
